...
public class FragmentMessage extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_main_message, container, false);

        mToolbar = (Toolbar) view.findViewById(R.id.message_toolbar);
        mToolbar.setTitle("消息");//设置主标题
    ...
    private void InitView() {
        fab = (FloatingActionButton) view.findViewById(R.id.message_fab);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.message_srl);
